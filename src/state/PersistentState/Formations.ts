...
export const formations: FormationsList = {
  'AWAY-433': [
    ...
    { positions: ['DEF'], block: 118 },
    { positions: ['DEF'], block: 148 },
    { positions: ['MID'], block: 41 },
    { positions: ['MID'], block: 131 },
  ...
  'HOME-433': [
    ...
    { positions: ['DEF'], block: 106 },
    { positions: ['DEF'], block: 136 },
    { positions: ['MID'], block: 33 },
    { positions: ['MID'], block: 79 },
